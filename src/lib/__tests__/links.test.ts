...
describe("query params", () => {
  it("strips tracking params from a launchpad link", () => {
  ...
  it("keeps the path, which is what distinguishes two tokens on one launchpad", () => {
...
describe("chat links", () => {
  it("rejects a telegram invite in the launchpad field", () => {
